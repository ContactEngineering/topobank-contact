...
def test_download_actual_contact_analysis_to_zip(
    ...
    exp_plot_content = (
        ...
        "0,1.6537790630515102e-07,4.371584699453552e-05,2.1084156348698166,True,result-step-1.nc\n"
        "1,1.468099887255917e-06,0.00017486338797814208,2.043365834308209,True,result-step-7.nc\n"
        "2,4.3372218508951826e-06,0.0005245901639344263,1.979349268082379,True,result-step-5.nc\n"
        "3,1.7512125354968008e-05,0.0018797814207650273,1.8561513580356102,True,result-step-4.nc\n"
        "4,4.656089565527125e-05,0.0051147540983606556,1.7427931604060252,True,result-step-8.nc\n"
        "5,9.512765774766276e-05,0.009530054644808742,1.641324313947533,True,result-step-3.nc\n"
        "6,0.00023888767275195301,0.02041530054644809,1.4664601572611478,True,result-step-9.nc\n"
        "7,0.00044130574852529596,0.035584699453551916,1.327983621445351,True,result-step-2.nc\n"
        "8,0.001628504480142861,0.10854644808743169,1.0017942767814618,True,result-step-0.nc\n"
        "9,0.005821949820486111,0.2766338797814208,0.6502049829740292,True,result-step-6.nc\n"
    )
